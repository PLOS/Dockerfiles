<#--
  $HeadURL: http://ambraproject.org/svn/plos/templates/head/journals/PLoSDefault/webapp/article/browseIssue.ftl $
  ...
  <div class="related">
    ...
    <ul>
      <#list articleInfo.relatedArticles as ra>
        ...
        <li><a href="${docURL}"
               title="Read Open Access Article"><@articleFormat>${ra.title}</@articleFormat></a></li>
      </#list>
    </ul>
  </div>
  </#if>
