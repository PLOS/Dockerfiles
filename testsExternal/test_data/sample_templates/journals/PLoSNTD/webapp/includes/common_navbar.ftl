      ...
      <div class="submenu">
        <div class="menu">
          <ul>
            ...
            <li><a href="${freemarker_config.journalUrls.PLoSCollections}/static/pntdCollections">Collections</a></li>
          </ul>
        </div>
      </div>
    </li>
    <li id="mn-02" ><a href="javascript:void(0);">Publish</a>
      <div class="submenu" style="width: 980px; margin-left: -521px; padding-bottom: 0">
          ...
          <div class="calloutcontainer">
            ...
            <div class="action-contain">
              <p class="callout-content">
               <em>PLOS Neglected Tropical Diseases</em> is the top Open Access tropical medicine journal, featuring an International Editorial Board and increased  <a href="http://www.plos.org/newsroom/viewpoints/global-participation-initiative/">support</a> for developing country authors.
             </p>
              <p class="button-contain">
                <a class="button btn-style brand" href="${submitnowURL}">
                 Get Started
               </a>
           </p>
         </div>  
  ...
  <div class="submenu" style="width:248px; margin-left:-30px;">
    <div class="menu">
      <ul>
        ...
        <li><a href="${editorsinchiefURL}">Editors-in-Chief</a></li>
