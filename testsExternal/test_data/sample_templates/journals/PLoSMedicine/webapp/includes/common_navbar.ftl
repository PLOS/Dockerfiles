...
<@s.url action="callforpapers" namespace="/static" includeParams="none" id="callforpapersURL"/>
      ...
      <div class="submenu">
        <div class="menu">
          <ul>
            ...
            <li><a href="${freemarker_config.journalUrls.PLoSCollections}/static/pmedCollections">Collections</a></li>
          </ul>
        </div>
      </div>
    </li>
