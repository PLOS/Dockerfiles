...
wait_and_curl https://nedcas-lb:443 /cas/login "CAS"
wait_and_curl https://akita-lb /registration/new "Akita"
wait_and_curl mailcatcher:1080 / "Mailcatcher"
test_up https://akita-lb/flanders/v1/types/countries "Rails_to_NED"
